...
envs = ['MinitaurBulletEnv-v0']
# envs = ['Walker2DBulletEnv-v0', 'AntBulletEnv-v0', 'HalfCheetahBulletEnv-v0', 'HopperBulletEnv-v0']
seeds = [0, 1, 2]
algos = ['trpo']
...
betas = [(0.1, 0.1)] #(0.5, 0.5), (0.9, 0.9), (0.9, 0.99)]
lrs = [0.005] # NOTE: if have more than 1 lr, make sure TRPO only runs once!
use_nn_policy = [True] #False, True]
...
# all_variants = copy.deepcopy(list(chain(variants2a, variants2b)))
