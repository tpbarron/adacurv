...
def plot(tag='mlp', bs=250, subtag='batch', lr='0.001', file='data', fig_ax=None, seeds=[0, 1, 2]):
    ...
    print (np.round(natural_adam_max_mean, 2), "& ", end='')
    print (np.round(natural_amsgrad_max_mean, 2), "& ", end='')
    print (np.round(natural_adagrad_max_mean, 2), "& ", end='')
    print (np.round(ngd_max_mean, 2), "& ", end='')
    print (np.round(adam_max_mean, 2), "& ", end='')
    print (np.round(amsgrad_max_mean, 2), "& ", end='')
    print (np.round(adagrad_max_mean, 2), "& ", end='')
    print (np.round(sgd_max_mean, 2))
